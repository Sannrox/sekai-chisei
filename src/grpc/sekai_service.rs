...
#[derive(Debug)]
struct GuardedCreateObjectResponse {
    object: Option<Object>,
}

struct GuardedUpdateObjectRequest {
    object: Option<Object>,
    lease_precondition: Option<LeasePrecondition>,
}

#[derive(Debug)]
struct GuardedUpdateObjectResponse {
    object: Option<Object>,
}

struct GuardedDeleteObjectRequest {
    id: String,
    lease_precondition: Option<LeasePrecondition>,
}

#[derive(Debug)]
struct GuardedDeleteObjectResponse {}
...
impl SekaiService for SekaiServiceImpl {
    ...
    async fn create_object(
        ...
        // Unified mutation path (#388): optional lease_precondition selects the
        // internal generation-fenced implementation.
