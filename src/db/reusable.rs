...
use crate::db::definition_branch::POSTGRES_DEFINITION_BRANCH_SURFACE;
use crate::db::graph::POSTGRES_GRAPH_SURFACES;
use crate::db::object_security::POSTGRES_OBJECT_SECURITY_SURFACE;
...
pub const POSTGRES_FOUNDATION_SURFACES: &[&str] = &[
    ...
    POSTGRES_OBJECT_SECURITY_SURFACE,
