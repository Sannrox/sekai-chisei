    ...
    pub(crate) fn migrate_chisei(&self) -> Result<(), String> {
        ...
        conn.execute_batch(
            ...
            CREATE TABLE IF NOT EXISTS chisei_operation_reservations (
                ...
                incurred_usage INTEGER NOT NULL DEFAULT 0,
...
impl SekaiDb {
    ...
    pub fn count_active_kioku_promotions_in_window(
        ...
        conn.query_row(
            ...
            rusqlite::params![namespace, start_timestamp_ms, end_timestamp_ms],
            |row| row.get(0),
        )
        .map_err(|error| error.to_string())
    }
    ...
    pub fn list_kioku_lifecycle_events_in_window(
        ...
        let rows = statement
            .query_map(
                rusqlite::params![namespace, start_timestamp_ms, end_timestamp_ms, limit],
                |row| {
