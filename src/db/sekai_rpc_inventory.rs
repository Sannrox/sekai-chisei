...
mod tests {
    ...
    fn inventory_matches_proto_and_evidence_paths() {
        ...
        assert_eq!(inventory.entries.len(), 108);
        ...
        assert!(inventory.entry("CreateObjectSecurityPolicy").is_some());
        assert!(inventory.entry("ActivateObjectSecurityProfile").is_some());
