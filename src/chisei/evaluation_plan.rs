...
pub fn prepare_definition(
    ...
    let parameter_schema = crate::sekai::facts::parameter_schema::parse_parameter_schema(
...
pub fn validate_parameters(schema_json: &str, parameters_json: &str) -> Result<(), String> {
    let schema = crate::sekai::facts::parameter_schema::parse_parameter_schema(schema_json)?;
    ...
    for (name, value) in object {
        ...
        crate::sekai::facts::parameter_schema::validate_parameter_value(name, property, value)?;
    }
    Ok(())
}
...
pub fn validate_parameter_schema(schema_json: &str) -> Result<(), String> {
    crate::sekai::facts::parameter_schema::validate_parameter_schema(schema_json)
}
