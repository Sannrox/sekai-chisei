...
| `system_one` | Optional Function bind. Pinned model plus question-to-parameter map. Empty means preview does not fill. See [ADR 0082](decisions/0082-system-one-action-function.md) |
