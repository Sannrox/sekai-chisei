...
| `SekaiService.ListOntologyClasses` | `sekai.ontology-definitions` | yes | none | `stable` |
| `SekaiService.GetOntologyClass` | `sekai.ontology-definitions` | yes | none | `stable` |
...
| `SekaiService.ListOntologyRelations` | `sekai.ontology-definitions` | yes | none | `stable` |
| `SekaiService.GetOntologyRelation` | `sekai.ontology-definitions` | yes | none | `stable` |
...
| `SekaiService.CreateDataset` | `sekai.datasets` | yes | none | `experimental` |
| `SekaiService.UpdateDataset` | `sekai.datasets` | yes | none | `experimental` |
| `SekaiService.ListDatasets` | `sekai.datasets` | yes | none | `experimental` |
| `SekaiService.AppendRows` | `sekai.datasets` | yes | none | `experimental` |
| `SekaiService.QueryRows` | `sekai.datasets` | yes | none | `experimental` |
